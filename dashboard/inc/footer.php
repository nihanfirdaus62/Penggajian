<footer class="position-fixed bottom-0 p-3">
        <div class="container-fluid">
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start position-fixed bottom-0 end-0 p-3"">
                © <script>
                  document.write(new Date().getFullYear())
                </script>,
                made with <i class="fa fa-heart"></i> by
                <a href="https://music.youtube.com/watch?v=Q7vrK7pAhtc&list=RDAMVMVqX55vWu294" class="font-weight-bold" target="_blank">lmao</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
